  ...
  <tr>
	...
	<div class="contact">
		<div class="contact_container">
      	...
      	<tr>
      		<th colspan="2" class="bg-dark"> <h1 style="text-align:center;" class="text-white"> Results </h1></th>
         ...
         $Resultans = 0;
        	...
        	<td>
            <?php
            echo "Out of total, You have attempt ".$checked_count." option."; ?>
            </td>
		...
		<center>
      	<a href="lectures.php"  class="btn btn-success"> Back to Lectures </a>
		</center>
      </div>
