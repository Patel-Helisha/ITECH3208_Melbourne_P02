...
<div class="super_container">
  ...
  <tr>
	 ...
	 <?php	
			...
			Welcome Guest, (<a href="log_in.php" style="color:white;">Login</a>|<a href="register1.php" style="color:#F0B90D;">Register</a>)
			<?php
			}?>
	 </div>
	 </center></td>
				...
				<div class="row">
					<div class="col">
						<div class="section_title text-center">
							...
							<h1 style="font-size: 45px;"><b>Register</b></h1>
						</div>
						<div class="contact_text text-center">
							<p style="font-size: 22px;">Get yourself registered, for further access of the website.</p>
						</div>
						<div class="contact_form_container">
							...
							<br>
							<center><p style="color:black" ><a href="log_in.php" style="font-size: 22px;">Already have an account? Click here to login</a></p></center>
							</div>
						</div>
					</div>
				</div>
