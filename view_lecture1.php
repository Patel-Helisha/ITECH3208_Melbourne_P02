			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						...
						<h1 style="font-size:60px; padding-left:200px;"><b>Lecture 1</b></h1>
					</div>
				</div>
			</div>
			<br>
...
<p  style="font-size: 20px;"><h3 style="color:#2980B9; text-align:center;  font-weight:bold; font-size:22px; background-color: #D4E6F1;"> Upload your word document here summarizing the comprehension from lecture, and thereby get certified for the Influence course.</h3> </p>
	...
	<div class="review">
							   <?php
									...
									$lec_id = $_GET['lid'];
									 ...
									 $res2=mysqli_query($con,"SELECT `status` FROM `assignment` WHERE lid='$lec_id' AND uid='$id'");
									...
									if($status==1)
									{									
									$res1=mysqli_query($con,"select * from feedback WHERE fid=1");
									}
									else {
										$res1=mysqli_query($con,"select * from feedback WHERE fid=2");
									}
								...
								?>
								<center>
								<table  style="width:82%;   text-align:center; font-size:20px;
								 border-radius: 5px;
