...
<div class="contact">
		<div class="contact_container" style="border: 1px solid #cc0066;">
			<div class="container" >
			<br><br>
				<div class="row justify-content-center"  style="background-color: #1A5276;">
					<div class="column bg-light" style=" height: 500px; margin: 20px 50px; border: 1px solid #154360;" >
...
<?php
	$name= $_SESSION['fname'];
		...
		//booking for php booking and database connectivity
			...
			{
				echo "<br><p style='margin-top: 1px; Color:red; font-size: 60px;'>Sorry!!</p>";
				echo "<p style='margin-top:2px; font-size: 30px; color: #34495E;'>Tutor is not available on   $day .</p>";
			...
			else
			{
					...
					if( $count==0)
					{
						//$consultationsql = "INSERT INTO `consultationbooking`(`Tutor`, `Dates`, `Times`, `subject`, `EndDate`, `EndTime`, `name`) VALUES('$Tutors','$BookingDate','$BookingTime','$subject','$EndDate','$EndTime','$name')";
						//$consultationsql = "INSERT INTO `consultationbooking`(`Tutor`, `Dates`, `Times`, `subject`, `EndDate`, `EndTime`, `name`) VALUES ('$Tutors','$BookingDate','$BookingTime','$subject','$EndDate','$EndTime','$name')";
							//echo 	$consultationsql;
						if ($consultationconn->query($consultationsql) === TRUE) 
						{
							echo "<marquee style='padding-top:60px;'><h1 style='color:#B91777; padding-bottom:10px; font-size: 42px;'><b>BOOKING CONFIRMATION</b></h1></marquee>";
							echo "<br>";
							echo "<p style='Color:#34495E; font-weight:bold; font-size: 38px;'>Thank You.</p>";
					...
					else
					{
						...
						echo "<br><p style='margin-top: px; Color:#34495E; font-size: 60px;'>Sorry!!</p>";
	   ...
	   <form name="booking_confirmation" method="post" action="consultation1.php">
		...
		<input type="submit" value="Back" style=" color: white; font-size: 25px; border-radius: 8px; margin-top:30px; margin-left: 10px; background-color: #34495E; border: 1px solid #34495E; width: 100px; height: 45px;" name="submit" id="submit" align="center">
		</center>
		</form>
