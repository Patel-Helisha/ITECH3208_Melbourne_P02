...
?>
							...
							<div class='row'>
								...
								<?php
        $fetchVideos = mysqli_query($con, "SELECT * FROM videos ORDER BY vid DESC");
        while($row = mysqli_fetch_assoc($fetchVideos)){
            $location = $row['location'];
            
            echo "<div >";
            echo "<video src='".$location."' controls height='650' width='1350' >";
            echo "</div>";
        }
        ?>
			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-12">
					<div class="intro_content">
						...
						<br>
						<br>
							<h1 style="text-align:Left">Your Video Assignment:</h1>
						</div>
