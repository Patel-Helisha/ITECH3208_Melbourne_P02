			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-6">
					<div class="intro_content">
						<div class="section_title">
							<div>The Courses</div>
							<h1>Courses offered by Employability.Life</h1>
						</div>
						...
						<p></p>
							...
							Employability.life, has now showcased a platform for their student to attend online lectures.
							The Employability.life being a frontrunner in nationwide education, facilitates a pathway for students worldwide that are looking for higher and proffessional 
				...
				<div class="col-lg-6">
					<div class="intro_image">
						...
						<img src="image/ca.jpeg" alt="image" >
					</div>
				</div>
