...
<?php	
			$con=mysqli_connect("localhost","root","","employability");
			$res=mysqli_query($con,"select * FROM fquestion");
...
<h3 id="status" style="text-align:center;">Phase 1 of 3</h3>
<form class="form" id="multiphase" style="height:400px; width:900px;" onsubmit="return false">
  <div id="phase1">
    First Name: <input style="font-size:22px;" id="firstname" name="firstname" value=""><br>
    Last Name: <input style="font-size:22px;" id="lastname" name="lastname"><br>
