			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-12">
					<div class="intro_content">
						...
						<br><br>
						<br>
							<div style="text-align:center">Tube Sessions</div>
							<h1 style="font-size: 45px; text-align:center"><b>Courses</b></h1>
						</div>
						<div class="intro_text">
						<p></p>
							<p align="justify" style="font-size: 22px;">All the faculty members of the employability.life courses are very supportive and experienced. Students are given chance at this college to explore their inner creativity.
 ...
 while ($row=mysqli_fetch_array($res))
						{
								 ...
								 echo "<br>";
								 echo "<br>";
								 echo "<div style='color:#5D5458; font-size: 24px;'><b>";
								 echo 	$row["cname"];   
								 echo "</b></div>";  
								 echo 	"</h4>";
								 echo   "<br>";								 
								 ...
								 echo "</div>";
									echo "<br>";
									echo "<br>";
									echo "<button style='color:#5D5458; font-weight: bold; font-size: 20px; type='button' type='button' class='collapsible' onclick = 'return collapsible()'> Synopsis </button>";
