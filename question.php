  ...
  <tr>
	...
	<div class="intro">
		<div class="container">
          ...
          <main>
			<div class="container">
				<div class="current" style="font-size:26px; font-weight:bold; color:#283747; padding-bottom:15px; padding-left:65px;">Question <?php echo $number; ?> of <?php echo $total_questions; ?> </div>
				<p class="question" style="font-size:34px; font-weight:bold; color:#515A5; font-weight:bold; padding-bottom:1px; background-color:#f45106;"><?php echo $question['question_text']; ?> </p>
				<form method="POST" action="process.php" style="text-align:left; padding-top:10px;">
					<br><ul class="choicess" style="color:#283747;  font-size:26px;padding-bottom:2px; font-weight:bold;">
				...
				<?php
								 ...
								 if($number==10)
								{
									echo "<a href=final.php><input class='quiz'  name='submit' value='SUBMIT' style='text-align:center;'/></a>";
								}
								else
							    {
									echo "<a href=process.php><input type='submit' name='submit' class='quiz' value='Next' style='text-align:center;'/></a>";
